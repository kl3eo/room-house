...
//console.log('pos is', pos, 'el_id', el_id, 't1', t1, 't2', t2, 't3', t3);

	if ((el_id == "slot1" && t1 == 0) || (el_id == "slot2" && t2 == 0) || (el_id == "slot3" && t3 == 0)) pos = 1862;
	if ((el_id == "slot1" && t1 == 1) || (el_id == "slot2" && t2 == 1) || (el_id == "slot3" && t3 == 1)) pos = 7888;
	if ((el_id == "slot1" && t1 == 2) || (el_id == "slot2" && t2 == 2) || (el_id == "slot3" && t3 == 2)) pos = 7553;
	if ((el_id == "slot1" && t1 == 3) || (el_id == "slot2" && t2 == 3) || (el_id == "slot3" && t3 == 3)) pos = 7262;
	if ((el_id == "slot1" && t1 == 4) || (el_id == "slot2" && t2 == 4) || (el_id == "slot3" && t3 == 4)) pos = 2085;
	if ((el_id == "slot1" && t1 == 5) || (el_id == "slot2" && t2 == 5) || (el_id == "slot3" && t3 == 5)) pos = 4450;
    ...
    */
    Slot.prototype.reset = function() {
        ...
        $(this.el).css('background-position', '-8px 5px');
        this.speed = 0;
        completed = 0;
        $('#result').html('');
    };
