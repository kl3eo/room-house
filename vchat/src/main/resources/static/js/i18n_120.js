...
var left_content = new Map([
   ['en', 'Yes, now please say "Messi!" LOUDLY in microphone to redouble your vote. Thank you for voting! You may also write some words: <input type=text id=lsender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'writeToLog\', text:this.value});mod3.close();} else {this.placeholder = \'???\';}}">'],
   ['ru', 'Да, теперь, пожалуйста, скажи "Месси!" ГРОМКО в микрофон, чтобы подтвердить свой голос. Спасибо! <input type=text id=lsender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'writeToLog\', text:this.value});mod3.close();} else {this.placeholder = \'???\';}}">'],
   ['es', 'Sí, ahora por favor di "¡Messi!" VOZ ALTA en el micrófono para redoblar su voto. Gracias por votar! Tambien puedes escribir algo: <input type=text id=lsender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'writeToLog\', text:this.value});mod3.close();} else {this.placeholder = \'???\';}}">'],
   ...
   ['cn', 'Yes, now please say "Messi!" LOUDLY in microphone to redouble your vote. Thank you for voting! You may also write some words: <input type=text id=lsender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'writeToLog\', text:this.value});mod3.close();} else {this.placeholder = \'???\';}}">'],   
   ['pt', 'Sim, agora por favor diga "Messi!" ALTO no microfone para confirmar seu voto. Obrigado por votar! You may also write some words: <input type=text id=lsender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'writeToLog\', text:this.value});mod3.close();} else {this.placeholder = \'???\';}}">'],
]);
...
var central_content = new Map([
   ['en', 'WRITE TO CHAT: <input type=text id=lsender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'writeToLog\', text:this.value.replace(/\'/g, \'\')});mod5.close();} else {this.placeholder = \'???\';}}">'],
   ['ru', 'WRITE TO CHAT: <input type=text id=lsender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'writeToLog\', text:this.value.replace(/\'/g, \'\')});mod5.close();} else {this.placeholder = \'???\';}}">'],
   ['es', 'WRITE TO CHAT: <input type=text id=lsender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'writeToLog\', text:this.value.replace(/\'/g, \'\')});mod5.close();} else {this.placeholder = \'???\';}}">'],
   ['fr', 'WRITE TO CHAT: <input type=text id=lsender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'writeToLog\', text:this.value.replace(/\'/g, \'\')});mod5.close();} else {this.placeholder = \'???\';}}">'],
   ['cn', 'WRITE TO CHAT: <input type=text id=lsender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'writeToLog\', text:this.value.replace(/\'/g, \'\')});mod5.close();} else {this.placeholder = \'???\';}}">'],   
   ['pt', 'WRITE TO CHAT: <input type=text id=lsender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'writeToLog\', text:this.value.replace(/\'/g, \'\')});mod5.close();} else {this.placeholder = \'???\';}}">'],
]);

var anno_adder_content = new Map([
   ['en', 'SET ANNOTATION: <input type=text id=asender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'setAnno\', anno:this.value.replace(/\'/g, \'\')});mod7.close();} else {this.placeholder = \'???\';}}">'],
   ['ru', 'SET ANNOTATION: <input type=text id=asender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'setAnno\', anno:this.value.replace(/\'/g, \'\')});mod7.close();} else {this.placeholder = \'???\';}}">'],
   ['es', 'SET ANNOTATION: <input type=text id=asender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'setAnno\', anno:this.value.replace(/\'/g, \'\')});mod7.close();} else {this.placeholder = \'???\';}}">'],
   ['fr', 'SET ANNOTATION: <input type=text id=asender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'setAnno\', anno:this.value.replace(/\'/g, \'\')});mod7.close();} else {this.placeholder = \'???\';}}">'],
   ['cn', 'SET ANNOTATION: <input type=text id=asender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'setAnno\', anno:this.value.replace(/\'/g, \'\')});mod7.close();} else {this.placeholder = \'???\';}}">'],   
   ['pt', 'SET ANNOTATION: <input type=text id=asender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'setAnno\', anno:this.value.replace(/\'/g, \'\')});mod7.close();} else {this.placeholder = \'???\';}}">'],
]);
