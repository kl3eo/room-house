...
var central_content = new Map([
   ['en', 'WRITE TO CHAT: <input type=text id=lsender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'writeToLog\', text:this.value.replace(/\'/g, \'\')});mod5.close();document.body.style.background = \'#112\';cli5();} else {this.placeholder = \'???\';}}">'],
   ['ru', 'WRITE TO CHAT: <input type=text id=lsender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'writeToLog\', text:this.value.replace(/\'/g, \'\')});mod5.close();document.body.style.background = \'#112\';cli5();} else {this.placeholder = \'???\';}}">'],
   ['es', 'WRITE TO CHAT: <input type=text id=lsender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'writeToLog\', text:this.value.replace(/\'/g, \'\')});mod5.close();document.body.style.background = \'#112\';cli5();} else {this.placeholder = \'???\';}}">'],
   ['fr', 'WRITE TO CHAT: <input type=text id=lsender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'writeToLog\', text:this.value.replace(/\'/g, \'\')});mod5.close();document.body.style.background = \'#112\';cli5();} else {this.placeholder = \'???\';}}">'],
   ['cn', 'WRITE TO CHAT: <input type=text id=lsender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'writeToLog\', text:this.value.replace(/\'/g, \'\')});mod5.close();document.body.style.background = \'#112\';cli5();} else {this.placeholder = \'???\';}}">'],   
   ['pt', 'WRITE TO CHAT: <input type=text id=lsender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'writeToLog\', text:this.value.replace(/\'/g, \'\')});mod5.close();document.body.style.background = \'#112\'; cli5();} else {this.placeholder = \'???\';}}">'],
]);
