...
var anno_adder_content = new Map([
   ...
   ['pt', 'SET ANNOTATION: <input type=text id=asender value="" onkeydown="var Ucode=event.keyCode? event.keyCode : event.charCode; if (Ucode == 13) {if (this.value.length) {sendMessage({id : \'setAnno\', anno:this.value.replace(/\'/g, \'\'), addr: who_to});mod7.close();} else {this.placeholder = \'???\';}}">'],
]);
