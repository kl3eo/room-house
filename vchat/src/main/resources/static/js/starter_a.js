...
var voting_shown = w[0] === "clubb" ? 1 : 0;
...
*/
  ...
  if(role == 0) {(function() { soundEffect.volume=1; soundEffect.src = '/sounds/sound_on2.mp3';}).delay(10000);}
  ...
  if (voting_shown) {(function(){$('room-header').style.marginTop = '8vw'; $('subcontrols').style.display='block'; $('subcontrols').fade(1);}).delay(1000);} else  {$('room-header').style.marginTop = small_device ?  '0vw' : '8vw';}
