...
function ed() {
 ...
 if (obj.name && obj.name.length) {
  ...
  if (pcounter < room_limit + 1) {$('bell').style.display = 'none'; $('av_toggler').style.display='block';}
  if (pcounter > room_limit) {$('bell').style.display = 'block'; $('av_toggler').style.display='none';}
