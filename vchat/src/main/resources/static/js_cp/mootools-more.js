...
// Load this file's selection again by visiting: http://mootools.net/more/085e7f4468b45e8d4efd6a15dbda9152 
...
},getTag:function(){return this.tagName.toLowerCase();},setHTML:function(){this.innerHTML=$A(arguments).join("");
return this;},getTextInRange:function(b,a){return this.get("value").substring(b,a);},getSelectedText:function(){if(this.setSelectionRange){return this.getTextInRange(this.getSelectionStart(),this.getSelectionEnd());
